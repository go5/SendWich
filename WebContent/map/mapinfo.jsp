...
<body>
	...
	<input type="hidden" value="${param.keyword }" id="keyword"
		name="keyword">
	<input type="hidden" value="${param.loc_name }" id="loc_name" name="loc_name">
	<input type="hidden" value="${param.gis_x }" id="gis_x" name="gis_x">
			...
			<c:choose>
				...
				<c:when test="${empty memberDTO}">
					<div class="hero-unit" style="background-color: lightgray">
						...
						<p>
							<a href="main?cmd=ABOUTUS" class="btn btn-primary btn-large">글쓰기.
								&raquo;</a>
						</p>
					</div>
				</c:when>
	...
	<script type="text/javascript"
		src="//apis.daum.net/maps/maps3.js?apikey=4491cfa019e7f26639c2a14e621d321d408d3b0b"></script>
	<!-- 192.168.10.21
<script type="text/javascript" src="//apis.daum.net/maps/maps3.js?apikey=de78da4c647327ca076e1da781a14b50348fc85b"></script>
 -->
	<script>
