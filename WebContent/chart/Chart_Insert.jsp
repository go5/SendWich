...
<body>
	...
	<form method="post" action="/SendWich/chart?cmd=Chart_Insert"
		name="Chart_Insert" id="form">
		<!-- 게시판번호넘김 -->
		<input type="text" name="board_id" value="${param.board_id }" />
		<!-- 로컬정보 넘김 -->
		<input type="text" name="loc_id" value="${param.loc_id }" />
		...
		<div id="field2" style="float: left; visibility: hidden;">
			<div>
				<h2>평가</h2>
				<div>
					<span>주제</span> <input type="text" name="title2" id="title2" />
				</div>
			</div>
			<div>
				<div style="float: left">
					<span>항목</span> <input type="text" name="key2" id="key2" />
				</div>
				<div style="float: left">
					<span>값</span> <input type="text" name="value2" id="value2" />
				</div>
			</div>
			<div style="clear: both;"></div>
			<div>
		...
		<div class="span12" style="visibility: hidden" id="addbtn2">
			<input type="button" class="btn" id="addtitle2" value="추가" /> <input
				type="button" class="btn" id="deltitle1" value="삭제" /> <input
				class="btn" type="submit" value="등록" />
		</div>
		...
		<div id="field3" style="float: left; visibility: hidden;">
			<div>
				<h2>평가</h2>
				<div>
					<span>주제</span> <input type="text" name="title3" id="title3" />
				</div>
			</div>
			<div>
				<div style="float: left">
					<span>항목</span> <input type="text" name="key3" id="key3" />
				</div>
				<div style="float: left">
					<span>값</span> <input type="text" name="value3" id="value3" />
				</div>
			</div>
			<div style="clear: both;"></div>
			<div>
		...
		<div class="span12" style="visibility: hidden" id="addbtn3">
			<input type="button" class="btn" id="deltitle2" value="삭제" /> <input
				class="btn" type="submit" value="등록" />
		</div>
